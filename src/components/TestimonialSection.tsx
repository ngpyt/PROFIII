...
const testimonials = [
  {
    ...
    role: "Студентка",
    content:
      "Благодаря CareerAI я нашла свое призвание в веб-разработке и уже начала стажировку в IT-компании.",
  ...
  },
  {
    ...
    role: "Выпускница",
    content:
      "CareerAI предложил мне курсы, которые идеально подошли для развития в выбранной профессии.",
